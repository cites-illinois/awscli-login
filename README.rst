...
refresh
    ...
    ..
        Why is the default 3000? See __init__.py:78
.. TODO THIS SEEMS LIKE A REALLY BAD IDEA IN THE CONFIG FILE
    force-refresh
        Forces a login attempt to the IdP using cookies
duration
...
http_header_factor
    Name of HTTP Header to store the user's Duo `factor`_ in::
...
..
	to use --ecp-endpoint-url set cli_follow_urlparam to false
    https://github.com/aws/aws-cli/issues/4473
